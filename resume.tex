...
\begin{cvhonors}
  ...
  % The date column in cvhonors was widened to 2.6cm in awesome-cv.cls to fit
  % this range; upstream's 1.5cm only fits a single year.
  \cvhonor{AWS Certified Solutions Architect -- Associate \textnormal{\textit{(expired)}}}{Amazon Web Services}{}{2022 -- 2025}
