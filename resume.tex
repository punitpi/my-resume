...
% Work authorization is public - see the Languages section at the end.
...
%-------------------------------------------------------------------------------
% Work authorization is deliberately public: in the DACH market it is a
% go/no-go filter recruiters look for, and stating it up front avoids the
% "do they need sponsorship?" question. Only the phone number is private
% (see the \privatebuild block near the top of this file).
%-------------------------------------------------------------------------------
\cvsection{Languages \& Work Authorization}
\begin{cvskills}
  \cvskill{Languages}{English (C1), German (A1, actively learning), Kannada (native)}
  \cvskill{Work authorization}{EU Blue Card (Austria) --- no sponsorship required}
\end{cvskills}
